...
namespace WebApp.Areas.Admin.Controllers
{
    ...
    public class XeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("XeId,Soxe,Tenloaixe,NgayDangKiem,HanBaoHiem,NgayDaiTuGanNhat,Tinhtrang,MaDv,LaixeId ,Ghichu")] TXe tXe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("XeId,Soxe,Tenloaixe,NgayDangKiem,HanBaoHiem,NgayDaiTuGanNhat,Tinhtrang, MaDv, LaixeId, Ghichu")] TXe tXe)
        {
            if (id != tXe.XeId)
            {
                return NotFound();
